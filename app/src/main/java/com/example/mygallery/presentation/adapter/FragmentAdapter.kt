...
class FragmentAdapter(private val onFeaturedClick: (Picture) -> Unit,
): PagingDataAdapter<Picture, ViewHolder>(PictureDiffUtilCallback()){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(PictureItemBinding.inflate(LayoutInflater.from(parent.context),parent,false),onFeaturedClick)
    }
